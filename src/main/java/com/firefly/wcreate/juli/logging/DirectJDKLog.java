...
class DirectJDKLog implements Log {
    ...
    private static final String SIMPLE_CFG="com.firefly.wcreate.juli.JdkLoggerConfig"; //doesn't exist
    private static final String FORMATTER="com.firefly.wcreate.juli.formatter";

...
package com.firefly.wcreate.naming;
...
/**
 * turnip JNDI Context implementation.
 *
...
public class NamingContext implements Context {
    ...
    private static final com.firefly.wcreate.juli.logging.Log log =
        com.firefly.wcreate.juli.logging.LogFactory.getLog(NamingContext.class);
     ...
     * @param name The name of the associated turnip Context
     */
    ...
    /**
     * Name of the associated turnip Context.
     */

 ...
 */
package com.firefly.wcreate.turnip.util;
...
public final class RequestUtil {
    ...
    private static final StringManager sm =
        StringManager.getManager("com.firefly.wcreate.turnip.util");
     ...
     *             com.firefly.wcreate.rabbit.util.http.RequestUtil#normalize(String)} as
     *             a replacement.
     */
    @Deprecated
    public static String normalize(String path) {
        return com.firefly.wcreate.rabbit.util.http.RequestUtil.normalize(path);
    }
     ...
     * @deprecated Deprecated to resolve a circular package dependency and will
     *             be removed in Tomcat 8.0.x. Use {@link
     *             com.firefly.wcreate.rabbit.util.http.RequestUtil#normalize(String,

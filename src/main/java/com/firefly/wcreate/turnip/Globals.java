...
import com.firefly.wcreate.rabbit.util.compat.JreVendor;
...
public final class Globals {
    ...
    public static final String ALT_DD_ATTR =
        "com.firefly.wcreate.turnip.deploy.alt_dd";
    ...
    public static final String DISPATCHER_TYPE_ATTR =
        "com.firefly.wcreate.turnip.core.DISPATCHER_TYPE";
    ...
    public static final String DISPATCHER_REQUEST_PATH_ATTR =
        "com.firefly.wcreate.turnip.core.DISPATCHER_REQUEST_PATH";
    ...
    public static final String RESOURCES_ATTR =
        "com.firefly.wcreate.turnip.resources";
    ...
    public static final String CLASS_PATH_ATTR =
        "com.firefly.wcreate.turnip.jsp_classpath";
    ...
    public static final String MBEAN_REGISTRY_ATTR =
        "com.firefly.wcreate.turnip.Registry";
    ...
    public static final String MBEAN_SERVER_ATTR =
        "com.firefly.wcreate.turnip.MBeanServer";
    ...
    public static final String NAMED_DISPATCHER_ATTR =
        "com.firefly.wcreate.turnip.NAMED";
     ...
     */
     public static final String SSI_FLAG_ATTR =
         "com.firefly.wcreate.turnip.ssi.SSIServlet";
    ...
    public static final String GSS_CREDENTIAL_ATTR =
        "com.firefly.wcreate.turnip.realm.GSS_CREDENTIAL";
     ...
     *
     * @see com.firefly.wcreate.turnip.comet.CometEvent#setTimeout(int)
     *
     * Duplicated here for neater code in the catalina packages.
     */
    ...
    public static final String COMET_TIMEOUT_ATTR =
        com.firefly.wcreate.coyote.Constants.COMET_TIMEOUT_ATTR;
    ...
    public static final String SENDFILE_FILENAME_ATTR =
            com.firefly.wcreate.coyote.Constants.SENDFILE_FILENAME_ATTR;
    ...
    public static final String SENDFILE_FILE_START_ATTR =
            com.firefly.wcreate.coyote.Constants.SENDFILE_FILE_START_ATTR;
    ...
    public static final String SENDFILE_FILE_END_ATTR =
            com.firefly.wcreate.coyote.Constants.SENDFILE_FILE_END_ATTR;
    ...
    public static final String REMOTE_ADDR_ATTRIBUTE =
            com.firefly.wcreate.coyote.Constants.REMOTE_ADDR_ATTRIBUTE;
    ...
    public static final String ASYNC_SUPPORTED_ATTR =
        "com.firefly.wcreate.turnip.ASYNC_SUPPORTED";
    ...
    public static final String PARAMETER_PARSE_FAILED_ATTR =
        "com.firefly.wcreate.turnip.parameter_parse_failed";
    ...
    public static final String PARAMETER_PARSE_FAILED_REASON_ATTR =
            "com.firefly.wcreate.turnip.parameter_parse_failed_reason";
    ...
    public static final boolean STRICT_SERVLET_COMPLIANCE =
        Boolean.parseBoolean(System.getProperty("com.firefly.wcreate.turnip.STRICT_SERVLET_COMPLIANCE", "false"));
     ...
     * <p>
     * This must be kept in sync with com.firefly.wcreate.jasper.Constants
     */

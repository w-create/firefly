...
package com.firefly.wcreate.turnip.ha.tcp;
...
import com.firefly.wcreate.turnip.ha.CatalinaCluster;
import com.firefly.wcreate.turnip.ha.ClusterDeployer;
import com.firefly.wcreate.turnip.ha.ClusterListener;
import com.firefly.wcreate.turnip.ha.ClusterManager;
import com.firefly.wcreate.turnip.ha.ClusterMessage;
import com.firefly.wcreate.turnip.ha.ClusterValve;
import com.firefly.wcreate.turnip.ha.session.ClusterSessionListener;
import com.firefly.wcreate.turnip.ha.session.DeltaManager;
import com.firefly.wcreate.turnip.ha.session.JvmRouteBinderValve;
import com.firefly.wcreate.turnip.ha.session.JvmRouteSessionIDBinderListener;
import com.firefly.wcreate.turnip.ha.session.SessionMessage;
import com.firefly.wcreate.turnip.ha.util.IDynamicProperty;
import com.firefly.wcreate.turnip.mbeans.MBeanUtils;
import com.firefly.wcreate.turnip.tribes.Channel;
import com.firefly.wcreate.turnip.tribes.ChannelListener;
import com.firefly.wcreate.turnip.tribes.Member;
import com.firefly.wcreate.turnip.tribes.MembershipListener;
import com.firefly.wcreate.turnip.tribes.group.GroupChannel;
import com.firefly.wcreate.turnip.tribes.group.interceptors.MessageDispatch15Interceptor;
import com.firefly.wcreate.turnip.tribes.group.interceptors.TcpFailureDetector;
...
public class SimpleTcpCluster extends LifecycleMBeanBase
     ...
     * @see com.firefly.wcreate.turnip.tribes.group.GroupChannel#heartbeat()
     */
     ...
     * 
     * @see com.firefly.wcreate.turnip.ha.CatalinaCluster#addClusterListener(com.firefly.wcreate.turnip.ha.ClusterListener)
     */
    @Override
     ...
     * 
     * @see com.firefly.wcreate.turnip.ha.CatalinaCluster#removeClusterListener(com.firefly.wcreate.turnip.ha.ClusterListener)
     */
    @Override
     ...
     * @see com.firefly.wcreate.turnip.Cluster#createManager(java.lang.String)
    ...
    public synchronized Manager createManager(String name) {
        ...
        try {
            ...
            log.error("Unable to clone cluster manager, defaulting to com.firefly.wcreate.turnip.ha.session.DeltaManager", x);
            manager = new com.firefly.wcreate.turnip.ha.session.DeltaManager();
        } finally {
     ...
     * 
     * @see com.firefly.wcreate.turnip.Cluster#removeManager(Manager)
     */
    @Override
     ...
     * Get Manager
     * 
     * @see com.firefly.wcreate.turnip.ha.CatalinaCluster#getManager(java.lang.String)
     */
    @Override
     ...
     * @see com.firefly.wcreate.turnip.ha.deploy.FarmWarDeployer#backgroundProcess()
     * @see com.firefly.wcreate.turnip.tribes.group.GroupChannel#heartbeat()
     * @see com.firefly.wcreate.turnip.tribes.group.GroupChannel.HeartbeatThread#run()
     * 
     */
    @Override
     ...
     * 
     * @see com.firefly.wcreate.turnip.LifecycleListener#lifecycleEvent(com.firefly.wcreate.turnip.LifecycleEvent)
     * @deprecated  Unused - will be removed in Tomcat 8.0.x
     */
    @Override
    @Deprecated
     ...
     * 
     * @see com.firefly.wcreate.turnip.ha.CatalinaCluster#send(com.firefly.wcreate.turnip.ha.ClusterMessage)
     */
    @Override
     ...
     * 
     * @see com.firefly.wcreate.turnip.tribes.MembershipListener#memberAdded(com.firefly.wcreate.turnip.tribes.Member)
     */
    @Override
     ...
     * 
     * @see com.firefly.wcreate.turnip.tribes.MembershipListener#memberDisappeared(com.firefly.wcreate.turnip.tribes.Member)
     */
    @Override
    ...
    /**
     * 
     * @see com.firefly.wcreate.turnip.Cluster#setProtocol(java.lang.String)
     */
    @Override
    ...
    /**
     * @see com.firefly.wcreate.turnip.Cluster#getProtocol()
     */
    @Override

...
import com.firefly.wcreate.turnip.session.ManagerBase;
import com.firefly.wcreate.turnip.session.PersistentManager;
 ...
 * {@link com.firefly.wcreate.turnip.ha.session.JvmRouteSessionIDBinderListener
 ...
 * <pre>
 *  &lt;Cluster&gt;
 *  &lt;Valve className=&quot;com.firefly.wcreate.turnip.ha.session.JvmRouteBinderValve&quot; /&gt;
 *  &lt;/Cluster&gt;
 * </pre>
 * 
 * <br />
...
public class JvmRouteBinderValve extends ValveBase implements ClusterValve {
    ...
    /*--Static Variables----------------------------------------*/
    public static final com.firefly.wcreate.juli.logging.Log log = com.firefly.wcreate.juli.logging.LogFactory
            .getLog(JvmRouteBinderValve.class);

    /**
     * The descriptive information about this implementation.
     */
    protected static final String info = "com.firefly.wcreate.turnip.ha.session.JvmRouteBinderValve/1.2";
    ...
    protected String sessionIdAttribute = "com.firefly.wcreate.turnip.ha.session.JvmRouteOrignalSessionID";
     ...
     *            com.firefly.wcreate.turnip.ha.ClusterMessage)
     * @param sessionId

...
import com.firefly.wcreate.turnip.startup.ExpandWar;
...
import com.firefly.wcreate.rabbit.util.Diagnostics;
...
public class ManagerServlet extends HttpServlet implements ContainerServlet {
    ...
    static {
        String lastAccessAtStart = System.getProperty(
                "com.firefly.wcreate.turnip.session.StandardSession.LAST_ACCESS_AT_START");

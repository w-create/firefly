...
import com.firefly.wcreate.turnip.startup.ServerBoot;
...
public class SpnegoAuthenticator extends AuthenticatorBase {
    ...
    public String getInfo() {
        return "com.firefly.wcreate.turnip.authenticator.SpnegoAuthenticator/1.0";
    }
    ...
    protected void initInternal() throws LifecycleException {
        ...
        if (krb5Conf == null) {
            ...
            File krb5ConfFile = new File(ServerBoot.getCatalinaBase(),
        ...
        if (jaasConf == null) {
            // System property not set, use the Tomcat default
            File jaasConfFile = new File(ServerBoot.getCatalinaBase(),

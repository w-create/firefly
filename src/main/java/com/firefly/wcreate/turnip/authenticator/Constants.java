...
public class Constants {
    ...
    public static final String Package = "com.firefly.wcreate.turnip.authenticator";
    ...
    public static final String SINGLE_SIGN_ON_COOKIE =
        System.getProperty(
                "com.firefly.wcreate.turnip.authenticator.Constants.SSO_SESSION_COOKIE_NAME",
                "JSESSIONIDSSO");
    ...
    public static final String REQ_SSOID_NOTE =
      "com.firefly.wcreate.turnip.request.SSOID";
    ...
    public static final String SESS_PASSWORD_NOTE =
      "com.firefly.wcreate.turnip.session.PASSWORD";
    ...
    public static final String SESS_USERNAME_NOTE =
      "com.firefly.wcreate.turnip.session.USERNAME";
    ...
    public static final String FORM_PRINCIPAL_NOTE =
        "com.firefly.wcreate.turnip.authenticator.PRINCIPAL";
    ...
    public static final String FORM_REQUEST_NOTE =
        "com.firefly.wcreate.turnip.authenticator.REQUEST";

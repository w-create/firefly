...
import com.firefly.wcreate.rabbit.util.collections.ManagedConcurrentWeakHashMap;
...
public class DefaultInstanceManager implements InstanceManager {
    ...
    public DefaultInstanceManager(Context context, Map<String, Map<String, String>> injectionMap, com.firefly.wcreate.turnip.Context catalinaContext, ClassLoader containerClassLoader) {

...
public final class UserConfig
    ...
    private static final com.firefly.wcreate.juli.logging.Log log=
        com.firefly.wcreate.juli.logging.LogFactory.getLog( UserConfig.class );
     ...
     */
    private String configClass = "com.firefly.wcreate.turnip.startup.ContextConfig";


    /**
     * The Java class name of the Context implementation we should use.
     */
    private String contextClass = "com.firefly.wcreate.turnip.core.StandardContext";
    ...
    private String userClass =
        "com.firefly.wcreate.turnip.startup.PasswdUserDatabase";

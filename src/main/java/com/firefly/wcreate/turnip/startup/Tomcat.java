...
import com.firefly.wcreate.turnip.authenticator.NonLoginAuthenticator;
import com.firefly.wcreate.turnip.connector.Connector;
import com.firefly.wcreate.turnip.core.ContainerBase;
import com.firefly.wcreate.turnip.core.NamingContextListener;
 ...
 * implemented in com.firefly.wcreate.turnip.startup.Bootstrap.
 *
 * <p>
...
public class Tomcat {
    ...
    static final String[] silences = new String[] {
        "com.firefly.wcreate.coyote.http11.Http11Protocol",
        "com.firefly.wcreate.turnip.core.StandardService",
        "com.firefly.wcreate.turnip.core.StandardEngine",
        "com.firefly.wcreate.turnip.startup.ContextConfig",
        "com.firefly.wcreate.turnip.core.ApplicationContext",
        "com.firefly.wcreate.turnip.core.AprLifecycleListener"
    };
    ...
    public void enableNaming() {
        ...
        String value = "com.firefly.wcreate.naming";
        String oldValue =
        ...
        if (value == null) {
            System.setProperty
                (javax.naming.Context.INITIAL_CONTEXT_FACTORY,
                 "com.firefly.wcreate.naming.java.javaURLContextFactory");
        }
    }
    ...
    public static void initWebappDefaults(Context ctx) {
        ...
        Wrapper servlet = addServlet(
                ctx, "default", "com.firefly.wcreate.turnip.servlets.DefaultServlet");
        servlet.setLoadOnStartup(1);
        servlet.setOverridable(true);

        // JSP servlet (by class name - to avoid loading all deps)
        servlet = addServlet(
                ctx, "jsp", "com.firefly.wcreate.jasper.servlet.JspServlet");

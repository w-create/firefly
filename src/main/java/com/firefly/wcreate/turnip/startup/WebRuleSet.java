...
import com.firefly.wcreate.turnip.deploy.ContextHandler;
import com.firefly.wcreate.turnip.deploy.ContextService;
import com.firefly.wcreate.turnip.deploy.ResourceBase;
...
import com.firefly.wcreate.rabbit.util.digester.CallMethodRule;
import com.firefly.wcreate.rabbit.util.digester.CallParamRule;
...
import com.firefly.wcreate.rabbit.util.digester.SetNextRule;
...
public class WebRuleSet extends RuleSetBase {
    ...
    public void addRuleInstances(Digester digester) {
        ...
        digester.addObjectCreate(fullPrefix + "/error-page",
                                 "com.firefly.wcreate.turnip.deploy.ErrorPage");
        ...
        digester.addObjectCreate(fullPrefix + "/filter",
                                 "com.firefly.wcreate.turnip.deploy.FilterDef");
        ...
        digester.addObjectCreate(fullPrefix + "/filter-mapping",
                                 "com.firefly.wcreate.turnip.deploy.FilterMap");
        ...
        digester.addObjectCreate(fullPrefix + "/jsp-config/jsp-property-group",
                                 "com.firefly.wcreate.turnip.deploy.JspPropertyGroup");
        ...
        digester.addObjectCreate(fullPrefix + "/login-config",
                                 "com.firefly.wcreate.turnip.deploy.LoginConfig");
        ...
        digester.addObjectCreate(fullPrefix + "/security-constraint",
                                 "com.firefly.wcreate.turnip.deploy.SecurityConstraint");
        ...
        digester.addObjectCreate(fullPrefix + "/security-constraint/web-resource-collection",
                                 "com.firefly.wcreate.turnip.deploy.SecurityCollection");
        ...
        digester.addSetNext(fullPrefix + "/servlet",
                            "addServlet",
                            "com.firefly.wcreate.turnip.deploy.ServletDef");
        ...
        digester.addObjectCreate(fullPrefix + "/servlet/security-role-ref",
                                 "com.firefly.wcreate.turnip.deploy.SecurityRoleRef");
        ...
        digester.addObjectCreate(fullPrefix + "/servlet/multipart-config",
                                 "com.firefly.wcreate.turnip.deploy.MultipartDef");
        ...
        digester.addObjectCreate(fullPrefix + "/session-config",
                                 "com.firefly.wcreate.turnip.deploy.SessionConfig");
    ...
    protected void configureNamingRules(Digester digester) {
        ...
        digester.addObjectCreate(fullPrefix + "/message-destination",
                                 "com.firefly.wcreate.turnip.deploy.MessageDestination");
        ...
        digester.addObjectCreate(fullPrefix + "/message-destination-ref",
                                 "com.firefly.wcreate.turnip.deploy.MessageDestinationRef");
        ...
        digester.addObjectCreate(fullPrefix + "/service-ref/handler",
                                 "com.firefly.wcreate.turnip.deploy.ContextHandler");
 ...
 * <code>com.firefly.wcreate.turnip.deploy.SecurityConstraint</code>.
 */
 ...
 * on the stack, which must be a <code>com.firefly.wcreate.turnip.Context</code>.
 */

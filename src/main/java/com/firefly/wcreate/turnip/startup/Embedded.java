 ...
 * this object.
 * <p>
 * @see com.firefly.wcreate.turnip.startup.Bootstrap#main For a complete example
...
public class Embedded  extends StandardService {
    ...
    protected static final String info =
        "com.firefly.wcreate.turnip.startup.Embedded/1.0";
    ...
    public Connector createConnector(String address, int port,
        ...
        try {
            ...
            if (protocol.equals("ajp")) {
                connector = new Connector("com.firefly.wcreate.coyote.ajp.AjpProtocol");
            } else if (protocol.equals("memory")) {
                connector = new Connector("com.firefly.wcreate.coyote.memory.MemoryProtocolHandler");
     ...
     * implement the com.firefly.wcreate.turnip.Valve interface
     */
     ...
     * {@link com.firefly.wcreate.turnip.util.LifecycleBase#startInternal()}.
     *
     ...
     * implement the requirements of
     * {@link com.firefly.wcreate.turnip.util.LifecycleBase#stopInternal()}.
     *
     * @exception LifecycleException if this component detects a fatal error

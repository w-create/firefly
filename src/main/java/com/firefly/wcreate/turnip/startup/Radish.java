...
public class Radish {
    ...
    protected Digester createStartDigester() {
        ...
        digester.addObjectCreate("Server",
                                 "com.firefly.wcreate.turnip.core.StandardServer",
                                 "className");
        digester.addSetProperties("Server");
        digester.addSetNext("Server",
                            "setServer",
                            "com.firefly.wcreate.turnip.Server");

        digester.addObjectCreate("Server/GlobalNamingResources",
                                 "com.firefly.wcreate.turnip.deploy.NamingResources");
        ...
        digester.addSetNext("Server/Service",
                            "addService",
                            "com.firefly.wcreate.turnip.Service");
        ...
        digester.addObjectCreate("Server/Service/Executor",
                         "com.firefly.wcreate.turnip.core.StandardThreadExecutor",
                         "className");
        digester.addSetProperties("Server/Service/Executor");

        digester.addSetNext("Server/Service/Executor",
                            "addExecutor",
                            "com.firefly.wcreate.turnip.Executor");
        ...
        digester.addSetNext("Server/Service/Connector",
                            "addConnector",
                            "com.firefly.wcreate.turnip.connector.Connector");
    ...
    private void addClusterRuleSet(Digester digester, String prefix) {
        ...
        try {
            clazz = Class.forName("com.firefly.wcreate.turnip.ha.ClusterRuleSet");
    ...
    public void load() {
        ...
        try {
            ...
            if (Boolean.getBoolean("com.firefly.wcreate.turnip.startup.EXIT_ON_INIT_FAILURE")) {
    ...
    protected void usage() {
        ...
        System.out.println
            ("usage: java com.firefly.wcreate.turnip.startup.Catalina"
             + " [ -config {pathname} ]"
             + " [ -nonaming ] "
             + " { -help | start | stop }");
    ...
    private static final com.firefly.wcreate.juli.logging.Log log=
        com.firefly.wcreate.juli.logging.LogFactory.getLog( Radish.class );

 ...
 */
package com.firefly.wcreate.turnip.connector;
...
import com.firefly.wcreate.turnip.Realm;
import com.firefly.wcreate.turnip.Session;
import com.firefly.wcreate.turnip.Wrapper;
import com.firefly.wcreate.turnip.core.ApplicationPart;
import com.firefly.wcreate.turnip.core.ApplicationSessionCookieConfig;
import com.firefly.wcreate.turnip.core.AsyncContextImpl;
import com.firefly.wcreate.turnip.realm.GenericPrincipal;
import com.firefly.wcreate.turnip.util.ParameterMap;
import com.firefly.wcreate.turnip.util.RequestUtil;
import com.firefly.wcreate.turnip.util.StringParser;
import com.firefly.wcreate.turnip.util.URLEncoder;
import com.firefly.wcreate.coyote.ActionCode;
...
import com.firefly.wcreate.rabbit.util.buf.B2CConverter;
import com.firefly.wcreate.rabbit.util.buf.ByteChunk;
import com.firefly.wcreate.rabbit.util.buf.MessageBytes;
import com.firefly.wcreate.rabbit.util.buf.UDecoder;
import com.firefly.wcreate.rabbit.util.compat.JreCompat;
import com.firefly.wcreate.rabbit.util.http.Cookies;
import com.firefly.wcreate.rabbit.util.http.FastHttpDateFormat;
import com.firefly.wcreate.rabbit.util.http.Parameters;
import com.firefly.wcreate.rabbit.util.http.Parameters.FailReason;
import com.firefly.wcreate.rabbit.util.http.ServerCookie;
import com.firefly.wcreate.rabbit.util.http.fileupload.FileItem;
import com.firefly.wcreate.rabbit.util.http.fileupload.FileUploadBase;
import com.firefly.wcreate.rabbit.util.http.fileupload.FileUploadBase.InvalidContentTypeException;
import com.firefly.wcreate.rabbit.util.http.fileupload.FileUploadException;
import com.firefly.wcreate.rabbit.util.http.fileupload.disk.DiskFileItemFactory;
import com.firefly.wcreate.rabbit.util.http.fileupload.servlet.ServletFileUpload;
import com.firefly.wcreate.rabbit.util.http.fileupload.servlet.ServletRequestContext;
import com.firefly.wcreate.rabbit.util.http.mapper.MappingData;
...
public class Request
     ...
     * Coyote request.
     */
    protected com.firefly.wcreate.coyote.Request coyoteRequest;
     ...
     */
    public void setCoyoteRequest(com.firefly.wcreate.coyote.Request coyoteRequest) {
     ...
     */
    public com.firefly.wcreate.coyote.Request getCoyoteRequest() {
    ...
    protected static final String info =
        "com.firefly.wcreate.coyote.catalina.CoyoteRequest/1.0";
     ...
     */
    protected com.firefly.wcreate.turnip.connector.Response response = null;

    /**
     * Return the Response with which this Request is associated.
     */
    public com.firefly.wcreate.turnip.connector.Response getResponse() {
     ...
     */
    public void setResponse(com.firefly.wcreate.turnip.connector.Response response) {
     ...
     * have names starting with "com.firefly.wcreate.rabbit" and include:
     * <ul>
    ...
    public void removeAttribute(String name) {
        ...
        if (name.startsWith("com.firefly.wcreate.rabbit.")) {
    ...
    public String getContextPath() {
        ...
        candidate = com.firefly.wcreate.rabbit.util.http.RequestUtil.normalize(candidate);
     ...
     */
    @Deprecated
    public void doUpgrade(com.firefly.wcreate.coyote.http11.upgrade.UpgradeInbound inbound)
            throws IOException {
        ...
        try {
            ...
            if (enc != null) {
                ...
                parameters.setEncoding
                    (com.firefly.wcreate.coyote.Constants.DEFAULT_CHARACTER_ENCODING);
                if (useBodyEncodingForURI) {

...
import com.firefly.wcreate.turnip.authenticator.AuthenticatorBase;
import com.firefly.wcreate.turnip.comet.CometEvent;
import com.firefly.wcreate.turnip.comet.CometEvent.EventType;
import com.firefly.wcreate.turnip.core.AsyncContextImpl;
import com.firefly.wcreate.turnip.util.ServerInfo;
import com.firefly.wcreate.turnip.util.SessionConfig;
import com.firefly.wcreate.turnip.util.URLEncoder;
import com.firefly.wcreate.coyote.ActionCode;
import com.firefly.wcreate.coyote.Adapter;
...
import com.firefly.wcreate.rabbit.util.buf.CharChunk;
...
public class CoyoteAdapter implements Adapter {
    ...
    protected static final boolean ALLOW_BACKSLASH =
        Boolean.parseBoolean(System.getProperty("com.firefly.wcreate.turnip.connector.CoyoteAdapter.ALLOW_BACKSLASH", "false"));
     ...
     */
    @Override
    public boolean event(com.firefly.wcreate.coyote.Request req,
            com.firefly.wcreate.coyote.Response res, SocketStatus status) {
    ...
    @Override
    public boolean asyncDispatch(com.firefly.wcreate.coyote.Request req,
            com.firefly.wcreate.coyote.Response res, SocketStatus status) throws Exception {
        Request request = (Request) req.getNote(ADAPTER_NOTES);
        Response response = (Response) res.getNote(ADAPTER_NOTES);
     ...
     */
    @Override
    public void service(com.firefly.wcreate.coyote.Request req,
                        com.firefly.wcreate.coyote.Response res)
        throws Exception {
    ...
    @Override
    public void errorDispatch(com.firefly.wcreate.coyote.Request req,
            com.firefly.wcreate.coyote.Response res) {
        Request request = (Request) req.getNote(ADAPTER_NOTES);
        Response response = (Response) res.getNote(ADAPTER_NOTES);
    ...
    @Override
    public void log(com.firefly.wcreate.coyote.Request req,
            com.firefly.wcreate.coyote.Response res, long time) {
    ...
    @Override
    public void checkRecycled(com.firefly.wcreate.coyote.Request req,
            com.firefly.wcreate.coyote.Response res) {
        Request request = (Request) req.getNote(ADAPTER_NOTES);
        Response response = (Response) res.getNote(ADAPTER_NOTES);
     ...
     */
    protected boolean postParseRequest(com.firefly.wcreate.coyote.Request req,
                                       Request request,
                                       com.firefly.wcreate.coyote.Response res,
                                       Response response)
            throws Exception {
    ...
    private void doConnectorAuthenticationAuthorization(com.firefly.wcreate.coyote.Request req, Request request) {
     ...
     * @param request
     */
    protected void parsePathParameters(com.firefly.wcreate.coyote.Request req,
            Request request) {
     ...
     */
    protected void parseSessionCookiesId(com.firefly.wcreate.coyote.Request req, Request request) {

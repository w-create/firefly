...
import com.firefly.wcreate.turnip.core.AprLifecycleListener;
...
public class Connector extends LifecycleMBeanBase  {
    ...
    public static final boolean RECYCLE_FACADES =
        Boolean.parseBoolean(System.getProperty("com.firefly.wcreate.turnip.connector.RECYCLE_FACADES", "false"));
    ...
    protected static final String info =
        "com.firefly.wcreate.turnip.connector.Connector/2.1";
    ...
    public String getProtocol() {
        ...
        if ("com.firefly.wcreate.coyote.http11.Http11Protocol".equals
            (getProtocolHandlerClassName())
            || "com.firefly.wcreate.coyote.http11.Http11AprProtocol".equals
            (getProtocolHandlerClassName())) {
            return "HTTP/1.1";
        } else if ("com.firefly.wcreate.coyote.ajp.AjpProtocol".equals
                   (getProtocolHandlerClassName())
                   || "com.firefly.wcreate.coyote.ajp.AjpAprProtocol".equals
                   (getProtocolHandlerClassName())) {
            return "AJP/1.3";
        }
        ...
        if (AprLifecycleListener.isAprAvailable()) {
            if ("HTTP/1.1".equals(protocol)) {
                setProtocolHandlerClassName
                    ("com.firefly.wcreate.coyote.http11.Http11AprProtocol");
            } else if ("AJP/1.3".equals(protocol)) {
                setProtocolHandlerClassName
                    ("com.firefly.wcreate.coyote.ajp.AjpAprProtocol");
            ...
            if ("HTTP/1.1".equals(protocol)) {
                ...
                setProtocolHandlerClassName
                    ("com.firefly.wcreate.coyote.ajp.AjpProtocol");
            } else if (protocol != null) {
                setProtocolHandlerClassName(protocol);
            }
        }
    ...
    public String getExecutorName() {
        ...
        if (obj instanceof com.firefly.wcreate.turnip.Executor) {
            return ((com.firefly.wcreate.turnip.Executor) obj).getName();
        }
        return "Internal";
    }

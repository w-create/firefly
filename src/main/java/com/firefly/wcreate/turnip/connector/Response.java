...
import com.firefly.wcreate.turnip.security.SecurityUtil;
import com.firefly.wcreate.turnip.util.DateTool;
...
import com.firefly.wcreate.rabbit.util.buf.UEncoder;
import com.firefly.wcreate.rabbit.util.buf.UEncoder.SafeCharsSet;
import com.firefly.wcreate.rabbit.util.http.FastHttpDateFormat;
import com.firefly.wcreate.rabbit.util.http.MimeHeaders;
import com.firefly.wcreate.rabbit.util.http.ResponseUtil;
import com.firefly.wcreate.rabbit.util.http.ServerCookie;
import com.firefly.wcreate.rabbit.util.http.parser.MediaTypeCache;
import com.firefly.wcreate.rabbit.util.net.URL;
...
public class Response implements HttpServletResponse {
    ...
    static {
        ...
        ENFORCE_ENCODING_IN_GET_WRITER = Boolean.parseBoolean(
                System.getProperty("com.firefly.wcreate.turnip.connector.Response.ENFORCE_ENCODING_IN_GET_WRITER",
                        "true"));
    }
     ...
     */
    protected static final String info = "com.firefly.wcreate.coyote.catalina.CoyoteResponse/1.0";
     ...
     * Coyote response.
     */
    protected com.firefly.wcreate.coyote.Response coyoteResponse;
     ...
     */
    public void setCoyoteResponse(com.firefly.wcreate.coyote.Response coyoteResponse) {
     ...
     */
    public com.firefly.wcreate.coyote.Response getCoyoteResponse() {
     ...
     */
    public com.firefly.wcreate.turnip.connector.Request getRequest() {
        return (this.request);
    }
     ...
     */
    public void setRequest(com.firefly.wcreate.turnip.connector.Request request) {
    ...
    /**
     * An extended version of this exists in {@link com.firefly.wcreate.coyote.Response}.
     ...
     * since usingWriter is not visible to {@link com.firefly.wcreate.coyote.Response}
     *

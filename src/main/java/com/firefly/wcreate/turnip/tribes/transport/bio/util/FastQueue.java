...
package com.firefly.wcreate.turnip.tribes.transport.bio.util;
...
public class FastQueue {
    ...
    private static final com.firefly.wcreate.juli.logging.Log log = com.firefly.wcreate.juli.logging.LogFactory.getLog(FastQueue.class);

...
import com.firefly.wcreate.turnip.tribes.group.InterceptorPayload;
...
public class TcpFailureDetector extends ChannelInterceptorBase {
    ...
    private static final com.firefly.wcreate.juli.logging.Log log = com.firefly.wcreate.juli.logging.LogFactory.getLog( TcpFailureDetector.class );

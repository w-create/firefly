...
import com.firefly.wcreate.turnip.tribes.transport.Constants;
import com.firefly.wcreate.turnip.tribes.transport.SenderState;
...
public class BioSender extends AbstractSender {
    ...
    private static final com.firefly.wcreate.juli.logging.Log log = com.firefly.wcreate.juli.logging.LogFactory.getLog(BioSender.class);
     ...
     * @see com.firefly.wcreate.turnip.tribes.transport.DataSender#connect()
     */
    @Override
     ...
     * 
     * @see com.firefly.wcreate.turnip.tribes.transport.DataSender#disconnect()
     */
    @Override
        ...
        try {
            ...
            while ((i != -1) && (bytesRead < Constants.ACK_COMMAND.length)) {
                ...
                if (ackbuf.doesPackageExist() ) {
                    ...
                    ackReceived = Arrays.equals(ackcmd,com.firefly.wcreate.turnip.tribes.transport.Constants.ACK_DATA);
                    failAckReceived = Arrays.equals(ackcmd,com.firefly.wcreate.turnip.tribes.transport.Constants.FAIL_ACK_DATA);
            ...
            if (!ackReceived) {
                ...
                throw new RemoteProcessException("Received a failed ack:com.firefly.wcreate.turnip.tribes.transport.Constants.FAIL_ACK_DATA");
            }
        } catch (IOException x) {

...
import com.firefly.wcreate.turnip.tribes.ByteMessage;
import com.firefly.wcreate.turnip.tribes.Channel;
import com.firefly.wcreate.turnip.tribes.ChannelException;
import com.firefly.wcreate.turnip.tribes.ChannelInterceptor;
import com.firefly.wcreate.turnip.tribes.ChannelListener;
import com.firefly.wcreate.turnip.tribes.ChannelMessage;
import com.firefly.wcreate.turnip.tribes.ChannelReceiver;
import com.firefly.wcreate.turnip.tribes.ChannelSender;
import com.firefly.wcreate.turnip.tribes.ErrorHandler;
import com.firefly.wcreate.turnip.tribes.Heartbeat;
import com.firefly.wcreate.turnip.tribes.ManagedChannel;
import com.firefly.wcreate.turnip.tribes.Member;
import com.firefly.wcreate.turnip.tribes.MembershipListener;
import com.firefly.wcreate.turnip.tribes.MembershipService;
import com.firefly.wcreate.turnip.tribes.RemoteProcessException;
import com.firefly.wcreate.turnip.tribes.UniqueId;
import com.firefly.wcreate.turnip.tribes.group.interceptors.MessageDispatchInterceptor;
import com.firefly.wcreate.turnip.tribes.io.BufferPool;
import com.firefly.wcreate.turnip.tribes.io.ChannelData;
import com.firefly.wcreate.turnip.tribes.io.XByteBuffer;
import com.firefly.wcreate.turnip.tribes.util.Arrays;
import com.firefly.wcreate.turnip.tribes.util.Logs;
...
public class GroupChannel extends ChannelInterceptorBase implements ManagedChannel {
     ...
     * @see com.firefly.wcreate.turnip.tribes.Channel
     */
    @Override
    ...
    protected synchronized void setupDefaultStack() throws ChannelException {
        ...
        if ( getFirstInterceptor() != null &&
            ...
            Class<?> clazz = null;
            try {
                clazz = Class.forName("com.firefly.wcreate.turnip.tribes.group.interceptors.MessageDispatch15Interceptor",
     ...
     * @throws ChannelException
     * @see com.firefly.wcreate.turnip.tribes.Channel#start(int)
     */
    @Override
     ...
     * @param svc int
     * @throws ChannelException
     * @see com.firefly.wcreate.turnip.tribes.Channel#stop(int)
     */
    @Override

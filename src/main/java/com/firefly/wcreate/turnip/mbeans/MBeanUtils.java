...
import com.firefly.wcreate.turnip.Group;
...
import com.firefly.wcreate.turnip.Role;
import com.firefly.wcreate.turnip.Server;
import com.firefly.wcreate.turnip.Service;
import com.firefly.wcreate.turnip.User;
import com.firefly.wcreate.turnip.UserDatabase;
...
import com.firefly.wcreate.turnip.deploy.ContextEnvironment;
import com.firefly.wcreate.turnip.deploy.ContextResource;
import com.firefly.wcreate.turnip.deploy.ContextResourceLink;
...
import com.firefly.wcreate.coyote.ProtocolHandler;
import com.firefly.wcreate.coyote.ajp.AjpAprProtocol;
import com.firefly.wcreate.coyote.ajp.AjpProtocol;
import com.firefly.wcreate.coyote.http11.Http11AprProtocol;
import com.firefly.wcreate.coyote.http11.Http11NioProtocol;
import com.firefly.wcreate.coyote.http11.Http11Protocol;
...
public class MBeanUtils {
    ...
    private static String exceptions[][] = {
        { "com.firefly.wcreate.turnip.users.MemoryGroup",
          "Group" },
        { "com.firefly.wcreate.turnip.users.MemoryRole",
          "Role" },
        { "com.firefly.wcreate.turnip.users.MemoryUser",
          "User" },
    };
    ...
    public static synchronized Registry createRegistry() {
        ...
        if (registry == null) {
            ...
            registry.loadDescriptors("com.firefly.wcreate.turnip.mbeans",  cl);
            registry.loadDescriptors("com.firefly.wcreate.turnip.authenticator", cl);
            registry.loadDescriptors("com.firefly.wcreate.turnip.core", cl);
            registry.loadDescriptors("com.firefly.wcreate.turnip", cl);
            registry.loadDescriptors("com.firefly.wcreate.turnip.deploy", cl);
            registry.loadDescriptors("com.firefly.wcreate.turnip.loader", cl);
            registry.loadDescriptors("com.firefly.wcreate.turnip.realm", cl);
            registry.loadDescriptors("com.firefly.wcreate.turnip.session", cl);
            registry.loadDescriptors("com.firefly.wcreate.turnip.startup", cl);
            registry.loadDescriptors("com.firefly.wcreate.turnip.users", cl);
            registry.loadDescriptors("com.firefly.wcreate.turnip.ha", cl);
            registry.loadDescriptors("com.firefly.wcreate.turnip.connector", cl);
            registry.loadDescriptors("com.firefly.wcreate.turnip.valves",  cl);
        }
        return (registry);
    ...
    public static void destroyMBean(ContextResource resource)
        ...
        if ("com.firefly.wcreate.turnip.UserDatabase".equals(resource.getType())) {

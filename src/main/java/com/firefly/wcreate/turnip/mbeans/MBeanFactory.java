...
import com.firefly.wcreate.turnip.authenticator.SingleSignOn;
...
import com.firefly.wcreate.turnip.core.StandardService;
import com.firefly.wcreate.turnip.loader.WebappLoader;
import com.firefly.wcreate.turnip.realm.DataSourceRealm;
import com.firefly.wcreate.turnip.realm.JDBCRealm;
import com.firefly.wcreate.turnip.realm.JNDIRealm;
import com.firefly.wcreate.turnip.realm.MemoryRealm;
import com.firefly.wcreate.turnip.realm.UserDatabaseRealm;
import com.firefly.wcreate.turnip.session.StandardManager;
import com.firefly.wcreate.turnip.startup.ContextConfig;
import com.firefly.wcreate.turnip.startup.HostConfig;
import com.firefly.wcreate.turnip.util.LifecycleMBeanBase;
import com.firefly.wcreate.turnip.valves.AccessLogValve;
import com.firefly.wcreate.turnip.valves.RemoteAddrValve;
import com.firefly.wcreate.turnip.valves.RemoteHostValve;
import com.firefly.wcreate.turnip.valves.ValveBase;


/**
 * <p>A <strong>ModelMBean</strong> implementation for the
 * <code>com.firefly.wcreate.turnip.core.StandardServer</code> component.</p>
 *
 * @author Amy Roh
 */
public class MBeanFactory {
    ...
    private static final com.firefly.wcreate.juli.logging.Log log =
        com.firefly.wcreate.juli.logging.LogFactory.getLog(MBeanFactory.class);
    ...
    public String findObjectName(String type) {
        ...
        if (type.equals("com.firefly.wcreate.turnip.core.StandardContext")) {
            return "StandardContext";
        } else if (type.equals("com.firefly.wcreate.turnip.core.StandardEngine")) {
            return "Engine";
        } else if (type.equals("com.firefly.wcreate.turnip.core.StandardHost")) {
            return "Host";
        } else {
            return null;
        }
    ...
    public String createStandardContext(String parent, 
        ...
        if(mserver.isRegistered(deployer)) {
            ...
            mserver.invoke(deployer, "manageApp",
                           new Object[] {context},
                           new String[] {"com.firefly.wcreate.turnip.Context"});

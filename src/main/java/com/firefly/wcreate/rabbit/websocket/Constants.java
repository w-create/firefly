 ...
 */
package com.firefly.wcreate.rabbit.websocket;
...
public class Constants {
    ...
    static final int DEFAULT_BUFFER_SIZE = Integer.getInteger(
            "com.firefly.wcreate.rabbit.websocket.DEFAULT_BUFFER_SIZE", 8 * 1024)
            .intValue();
    ...
    public static final String MAX_REDIRECTIONS_PROPERTY =
            "com.firefly.wcreate.rabbit.websocket.MAX_REDIRECTIONS";
    ...
    static final String DEFAULT_ORIGIN_HEADER_VALUE =
            System.getProperty("com.firefly.wcreate.rabbit.websocket.DEFAULT_ORIGIN_HEADER_VALUE");

    // Configuration for background processing checks intervals
    static final int DEFAULT_PROCESS_PERIOD = Integer.getInteger(
            "com.firefly.wcreate.rabbit.websocket.DEFAULT_PROCESS_PERIOD", 10)
            .intValue();
    ...
    static final boolean DISABLE_BUILTIN_EXTENSIONS =
            Boolean.getBoolean("com.firefly.wcreate.rabbit.websocket.DISABLE_BUILTIN_EXTENSIONS");
    static final boolean ALLOW_UNSUPPORTED_EXTENSIONS =
            Boolean.getBoolean("com.firefly.wcreate.rabbit.websocket.ALLOW_UNSUPPORTED_EXTENSIONS");

    // Configuration for stream behavior
    static final boolean STREAMS_DROP_EMPTY_MESSAGES =
            Boolean.getBoolean("com.firefly.wcreate.rabbit.websocket.STREAMS_DROP_EMPTY_MESSAGES");

    public static final boolean STRICT_SPEC_COMPLIANCE =
            Boolean.getBoolean("com.firefly.wcreate.rabbit.websocket.STRICT_SPEC_COMPLIANCE");

...
import com.firefly.wcreate.rabbit.websocket.WsWebSocketContainer;
import com.firefly.wcreate.rabbit.websocket.pojo.PojoEndpointServer;
import com.firefly.wcreate.rabbit.websocket.pojo.PojoMethodMapping;
...
public class WsServerContainer extends WsWebSocketContainer
    ...
    private volatile boolean enforceNoAddAfterHandshake =
            com.firefly.wcreate.rabbit.websocket.Constants.STRICT_SPEC_COMPLIANCE;

 ...
 */
package com.firefly.wcreate.rabbit.util.buf;
...
public final class UDecoder {
    ...
    public static final boolean ALLOW_ENCODED_SLASH =
        Boolean.parseBoolean(System.getProperty("com.firefly.wcreate.rabbit.util.buf.UDecoder.ALLOW_ENCODED_SLASH", "false"));

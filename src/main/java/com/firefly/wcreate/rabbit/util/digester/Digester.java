...
package com.firefly.wcreate.rabbit.util.digester;
...
public class Digester extends DefaultHandler2 {
    ...
    static {
        String className = System.getProperty("com.firefly.wcreate.rabbit.util.digester.PROPERTY_SOURCE");
        if (className!=null) {
            ...
            for (int i = 0; i < cls.length; i++) {
                try {
                    ...
                    LogFactory.getLog("com.firefly.wcreate.rabbit.util.digester.Digester").
    ...
    protected Log saxLog =
        LogFactory.getLog("com.firefly.wcreate.rabbit.util.digester.Digester.sax");
    ...
    protected void configure() {
        ...
        log = LogFactory.getLog("com.firefly.wcreate.rabbit.util.digester.Digester");
        saxLog = LogFactory.getLog("com.firefly.wcreate.rabbit.util.digester.Digester.sax");

 ...
 */
package com.firefly.wcreate.rabbit.util.log;
...
public class UserDataHelper {
    ...
    public UserDataHelper(Log log) {
        ...
        String configString = System.getProperty(
                "com.firefly.wcreate.juli.logging.UserDataHelper.CONFIG");
        ...
        suppressionTime = Integer.getInteger(
                "com.firefly.wcreate.juli.logging.UserDataHelper.SUPPRESSION_TIME",

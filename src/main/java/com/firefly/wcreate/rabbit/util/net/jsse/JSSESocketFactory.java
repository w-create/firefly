...
import com.firefly.wcreate.rabbit.util.file.ConfigFileLoader;
import com.firefly.wcreate.rabbit.util.net.AbstractEndpoint;
import com.firefly.wcreate.rabbit.util.net.Constants;
...
public class JSSESocketFactory implements ServerSocketFactory, SSLUtil {
    ...
    private static final com.firefly.wcreate.juli.logging.Log log =
        com.firefly.wcreate.juli.logging.LogFactory.getLog(JSSESocketFactory.class);
    private static final StringManager sm =
        StringManager.getManager("com.firefly.wcreate.rabbit.util.net.jsse.res");

...
import com.firefly.wcreate.rabbit.util.net.SSLSessionManager;
...
class JSSESupport implements SSLSupport, SSLSessionManager {
    ...
    private static final com.firefly.wcreate.juli.logging.Log log =
        com.firefly.wcreate.juli.logging.LogFactory.getLog(JSSESupport.class);
    ...
    /**
     * Copied from <code>com.firefly.wcreate.rabbit.valves.CertificateValve</code>
     */
    @Override

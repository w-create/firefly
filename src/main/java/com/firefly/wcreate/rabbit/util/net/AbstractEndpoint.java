...
import com.firefly.wcreate.rabbit.util.net.AbstractEndpoint.Acceptor.AcceptorState;
import com.firefly.wcreate.rabbit.util.res.StringManager;
import com.firefly.wcreate.rabbit.util.threads.LimitLatch;
import com.firefly.wcreate.rabbit.util.threads.ResizableExecutor;
import com.firefly.wcreate.rabbit.util.threads.TaskQueue;
import com.firefly.wcreate.rabbit.util.threads.TaskThreadFactory;
import com.firefly.wcreate.rabbit.util.threads.ThreadPoolExecutor;
/**
 *
 * @author fhanik
 * @author Mladen Turk
...
public abstract class AbstractEndpoint<S> {
    ...
    // -------------------------------------------------------------- Constants
    protected static final StringManager sm = StringManager.getManager("com.firefly.wcreate.rabbit.util.net.res");
     ...
     * without the {@link com.firefly.wcreate.coyote.ProtocolHandler} being aware of the
     * properties available on those sub-components. One example of such a
     * sub-component is the
     * {@link com.firefly.wcreate.rabbit.util.net.ServerSocketFactory}.
     */
     ...
     * {@link com.firefly.wcreate.coyote.ProtocolHandler} needs to be made available to

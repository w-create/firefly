...
import com.firefly.wcreate.rabbit.util.net.NioEndpoint.Poller;
import com.firefly.wcreate.rabbit.util.net.SecureNioChannel.ApplicationBufferHandler;
...
public class NioChannel implements ByteChannel{
    ...
    protected static final StringManager sm =
            StringManager.getManager("com.firefly.wcreate.rabbit.util.net.res");
     ...
     * TODO Implement this com.firefly.wcreate.rabbit.util.net.SecureNioChannel method
     */

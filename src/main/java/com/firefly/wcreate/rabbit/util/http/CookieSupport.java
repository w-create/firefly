 ...
 */
package com.firefly.wcreate.rabbit.util.http;
...
public final class CookieSupport {
    ...
    static {
        STRICT_SERVLET_COMPLIANCE = Boolean.parseBoolean(System.getProperty(
                "com.firefly.wcreate.rabbit.STRICT_SERVLET_COMPLIANCE",
                "false"));

        ALLOW_EQUALS_IN_VALUE = Boolean.parseBoolean(System.getProperty(
                "com.firefly.wcreate.rabbit.util.http.ServerCookie.ALLOW_EQUALS_IN_VALUE",
                "false"));

        ALLOW_HTTP_SEPARATORS_IN_V0 = Boolean.parseBoolean(System.getProperty(
                "com.firefly.wcreate.rabbit.util.http.ServerCookie.ALLOW_HTTP_SEPARATORS_IN_V0",
                "false"));

        String alwaysAddExpires = System.getProperty(
        "com.firefly.wcreate.rabbit.util.http.ServerCookie.ALWAYS_ADD_EXPIRES");
        ...
        String preserveCookieHeader = System.getProperty(
                "com.firefly.wcreate.rabbit.util.http.ServerCookie.PRESERVE_COOKIE_HEADER");
        ...
        String  fwdSlashIsSeparator = System.getProperty(
                "com.firefly.wcreate.rabbit.util.http.ServerCookie.FWD_SLASH_IS_SEPARATOR");
        ...
        ALLOW_NAME_ONLY = Boolean.parseBoolean(System.getProperty(
                "com.firefly.wcreate.rabbit.util.http.ServerCookie.ALLOW_NAME_ONLY",
                "false"));

...
public abstract class SSLImplementation {
    private static final com.firefly.wcreate.juli.logging.Log logger = com.firefly.wcreate.juli.logging.LogFactory
    ...
    private static final String JSSEImplementationClass =
        "com.firefly.wcreate.rabbit.util.net.jsse.JSSEImplementation";
    ...
    public static SSLImplementation getInstance(String className)
        ...
        try {
            ...
            if (JSSEImplementationClass.equals(className)) {
                return new com.firefly.wcreate.rabbit.util.net.jsse.JSSEImplementation();
            }

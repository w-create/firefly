...
import com.firefly.wcreate.jasper.compiler.Compiler;
...
import com.firefly.wcreate.jasper.compiler.ServletWriter;
import com.firefly.wcreate.jasper.compiler.TldLocation;
import com.firefly.wcreate.jasper.servlet.JasperLoader;
import com.firefly.wcreate.jasper.servlet.JspServletWrapper;
    ...
    public Compiler createCompiler() {
        ...
        if (options.getCompilerClassName() != null) {
            ...
            if (options.getCompiler() == null) {
                jspCompiler = createCompiler("com.firefly.wcreate.jasper.compiler.JDTCompiler");
                if (jspCompiler == null) {
                    jspCompiler = createCompiler("com.firefly.wcreate.jasper.compiler.AntCompiler");
                }
            } else {
                jspCompiler = createCompiler("com.firefly.wcreate.jasper.compiler.AntCompiler");
                if (jspCompiler == null) {

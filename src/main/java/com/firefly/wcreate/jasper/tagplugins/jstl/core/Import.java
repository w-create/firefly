...
package com.firefly.wcreate.jasper.tagplugins.jstl.core;

import com.firefly.wcreate.jasper.compiler.tagplugin.TagPlugin;
import com.firefly.wcreate.jasper.compiler.tagplugin.TagPluginContext;
import com.firefly.wcreate.jasper.tagplugins.jstl.Util;
...
public class Import implements TagPlugin {
    ...
    public void doTag(TagPluginContext ctxt) {
        ...
        ctxt.generateJavaSource(iauName + " = " +
                "com.firefly.wcreate.jasper.tagplugins.jstl.Util.isAbsoluteUrl(" + urlName + ");");
        ...
        if(hasVarReader){
            ...
            ctxt.generateJavaSource("            " + charSetName + " = " +
                    "com.firefly.wcreate.jasper.tagplugins.jstl.Util.getContentTypeAttribute(" + contentTypeName + ", \"charset\");");
            ctxt.generateJavaSource("            if(" + charSetName + " == null) " 
                    + charSetName + " = com.firefly.wcreate.jasper.tagplugins.jstl.Util.DEFAULT_ENCODING;");
            ctxt.generateJavaSource("        }else{");
            ctxt.generateJavaSource("            " + charSetName + " = com.firefly.wcreate.jasper.tagplugins.jstl.Util.DEFAULT_ENCODING;");
            ctxt.generateJavaSource("        }");
            ctxt.generateJavaSource("    }");
            ...
            ctxt.generateJavaSource("        " + tempReaderName + " = new java.io.InputStreamReader(" + inputStreamName + ", com.firefly.wcreate.jasper.tagplugins.jstl.Util.DEFAULT_ENCODING);");
            ctxt.generateJavaSource("    }");
            ...
            ctxt.generateJavaSource("    RequestDispatcher " + requestDispatcherName + " = " + servletContextName + ".getRequestDispatcher(com.firefly.wcreate.jasper.tagplugins.jstl.Util.stripSession("+urlName+"));");
            ctxt.generateJavaSource("    if(" + requestDispatcherName + " == null) throw new JspTagException(com.firefly.wcreate.jasper.tagplugins.jstl.Util.stripSession("+urlName+"));");
            
            //initialize a ImportResponseWrapper to include the resource
            ctxt.generateJavaSource("    com.firefly.wcreate.jasper.tagplugins.jstl.Util.ImportResponseWrapper " + irwName + " = new com.firefly.wcreate.jasper.tagplugins.jstl.Util.ImportResponseWrapper((HttpServletResponse) pageContext.getResponse());");
            ctxt.generateJavaSource("    if(" + charSetName + " == null){");
            ctxt.generateJavaSource("        " + charSetName + " = com.firefly.wcreate.jasper.tagplugins.jstl.Util.DEFAULT_ENCODING;");
            ctxt.generateJavaSource("    }");
            ...
            ctxt.generateJavaSource("        throw new JspTagException(" + irwName + ".getStatus()+\" \" + com.firefly.wcreate.jasper.tagplugins.jstl.Util.stripSession(" + urlName + "));");
            ctxt.generateJavaSource("    }");

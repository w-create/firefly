...
public class Set implements TagPlugin {
    ...
    public void doTag(TagPluginContext ctxt) {
        ...
        if(hasVar){
            ...
            ctxt.generateJavaSource("                        " + methodName + ".invoke(" + targetName + ", new Object[]{com.firefly.wcreate.el.lang.ELSupport.coerceToType(" + resultName + ", " + methodName + ".getParameterTypes()[0])});");
            ctxt.generateJavaSource("                    }else{");

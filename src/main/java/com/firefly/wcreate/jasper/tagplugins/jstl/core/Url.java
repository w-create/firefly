...
public class Url implements TagPlugin {
    ...
    public void doTag(TagPluginContext ctxt) {
        ...
        ctxt.generateJavaSource("String " + baseUrlName + " = " +
                "com.firefly.wcreate.jasper.tagplugins.jstl.Util.resolveUrl(" + valueName + ", " + contextName + ", pageContext);");
        ...
        ctxt.generateJavaSource("if(!com.firefly.wcreate.jasper.tagplugins.jstl.Util.isAbsoluteUrl(" + resultName + ")){");

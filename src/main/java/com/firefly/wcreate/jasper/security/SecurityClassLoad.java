...
package com.firefly.wcreate.jasper.security;
...
public final class SecurityClassLoad {
    ...
    private static final com.firefly.wcreate.juli.logging.Log log=
        com.firefly.wcreate.juli.logging.LogFactory.getLog( SecurityClassLoad.class );
    ...
    public static void securityClassLoad(ClassLoader loader){
        ...
        final String basePackage = "com.firefly.wcreate.jasper.";
        try {

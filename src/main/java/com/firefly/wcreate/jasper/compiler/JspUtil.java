...
public class JspUtil {
    ...
    public static String interpreterCall(boolean isTagFile, String expression,
        ...
        StringBuilder call = new StringBuilder(
                "("
                        + targetType
                        + ") "
                        + "com.firefly.wcreate.jasper.runtime.PageContextImpl.proprietaryEvaluate"
    ...
    public static String coerceToPrimitiveBoolean(String s,
        ...
        if (isNamedAttribute) {
            return "com.firefly.wcreate.jasper.runtime.JspRuntimeLibrary.coerceToBoolean("
                    + s + ")";
        } else {
    ...
    public static String coerceToBoolean(String s, boolean isNamedAttribute) {
        if (isNamedAttribute) {
            return "(java.lang.Boolean) com.firefly.wcreate.jasper.runtime.JspRuntimeLibrary.coerce("
    ...
    public static String coerceToPrimitiveByte(String s,
            boolean isNamedAttribute) {
        if (isNamedAttribute) {
            return "com.firefly.wcreate.jasper.runtime.JspRuntimeLibrary.coerceToByte("
                    + s + ")";
        } else {
            if (s == null || s.length() == 0) {
                return "(byte) 0";
    ...
    public static String coerceToByte(String s, boolean isNamedAttribute) {
        if (isNamedAttribute) {
            return "(java.lang.Byte) com.firefly.wcreate.jasper.runtime.JspRuntimeLibrary.coerce("
    ...
    public static String coerceToChar(String s, boolean isNamedAttribute) {
        if (isNamedAttribute) {
            return "com.firefly.wcreate.jasper.runtime.JspRuntimeLibrary.coerceToChar("
                    + s + ")";
        } else {
            if (s == null || s.length() == 0) {
                return "(char) 0";
    ...
    public static String coerceToCharacter(String s, boolean isNamedAttribute) {
        if (isNamedAttribute) {
            return "(java.lang.Character) com.firefly.wcreate.jasper.runtime.JspRuntimeLibrary.coerce("
    ...
    public static String coerceToPrimitiveDouble(String s,
            boolean isNamedAttribute) {
        if (isNamedAttribute) {
            return "com.firefly.wcreate.jasper.runtime.JspRuntimeLibrary.coerceToDouble("
                    + s + ")";
        } else {
            if (s == null || s.length() == 0) {
                return "(double) 0";
    ...
    public static String coerceToDouble(String s, boolean isNamedAttribute) {
        if (isNamedAttribute) {
            return "(java.lang.Double) com.firefly.wcreate.jasper.runtime.JspRuntimeLibrary.coerce("
                    + s + ", Double.class)";
        } else {
            if (s == null || s.length() == 0) {
    ...
    public static String coerceToPrimitiveFloat(String s,
            boolean isNamedAttribute) {
        if (isNamedAttribute) {
            return "com.firefly.wcreate.jasper.runtime.JspRuntimeLibrary.coerceToFloat("
                    + s + ")";
        } else {
            if (s == null || s.length() == 0) {
                return "(float) 0";
    ...
    public static String coerceToFloat(String s, boolean isNamedAttribute) {
        if (isNamedAttribute) {
            return "(java.lang.Float) com.firefly.wcreate.jasper.runtime.JspRuntimeLibrary.coerce("
    ...
    public static String coerceToInt(String s, boolean isNamedAttribute) {
        if (isNamedAttribute) {
            return "com.firefly.wcreate.jasper.runtime.JspRuntimeLibrary.coerceToInt("
                    + s + ")";
        } else {
            if (s == null || s.length() == 0) {
                return "0";
    ...
    public static String coerceToInteger(String s, boolean isNamedAttribute) {
        if (isNamedAttribute) {
            return "(java.lang.Integer) com.firefly.wcreate.jasper.runtime.JspRuntimeLibrary.coerce("
    ...
    public static String coerceToPrimitiveShort(String s,
            boolean isNamedAttribute) {
        if (isNamedAttribute) {
            return "com.firefly.wcreate.jasper.runtime.JspRuntimeLibrary.coerceToShort("
                    + s + ")";
        } else {
            if (s == null || s.length() == 0) {
                return "(short) 0";
    ...
    public static String coerceToShort(String s, boolean isNamedAttribute) {
        if (isNamedAttribute) {
            return "(java.lang.Short) com.firefly.wcreate.jasper.runtime.JspRuntimeLibrary.coerce("
    ...
    public static String coerceToPrimitiveLong(String s,
            boolean isNamedAttribute) {
        if (isNamedAttribute) {
            return "com.firefly.wcreate.jasper.runtime.JspRuntimeLibrary.coerceToLong("
                    + s + ")";
        } else {
            if (s == null || s.length() == 0) {
                return "(long) 0";
    ...
    public static String coerceToLong(String s, boolean isNamedAttribute) {
        if (isNamedAttribute) {
            return "(java.lang.Long) com.firefly.wcreate.jasper.runtime.JspRuntimeLibrary.coerce("
    ...
    public static String getTagHandlerClassName(String path, String urn,
        ...
        // com.firefly.wcreate.jsp.tag.web.foo

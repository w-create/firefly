...
import com.firefly.wcreate.jasper.compiler.ELNode.ELText;
import com.firefly.wcreate.jasper.compiler.ELNode.Function;
import com.firefly.wcreate.jasper.compiler.ELNode.Root;
import com.firefly.wcreate.jasper.compiler.ELNode.Text;
            ...
            if (quote == '\'' || quote == '\"') {
                if (trimmed.charAt(trimmedLen - 1) != quote) {
                    throw new IllegalArgumentException(Localizer.getMessage(
                            "com.firefly.wcreate.jasper.compiler.ELParser.invalidQuotesForStringLiteral",
                            input));
                }
        ...
        while (hasNextChar()) {
            ...
            if (ch == '\\') {
                ...
                if (ch == '\\' || ch == '\'' || ch == '\"') {
                    ...
                    throw new IllegalArgumentException(Localizer.getMessage(
                            "com.firefly.wcreate.jasper.compiler.ELParser.invalidQuoting",
                            expression));
                }
            } else if (ch == quote) {
                buf.append(ch);

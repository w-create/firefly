...
import com.firefly.wcreate.jasper.Constants;
import com.firefly.wcreate.jasper.JasperException;
import com.firefly.wcreate.jasper.JspCompilationContext;
import com.firefly.wcreate.jasper.compiler.Node.NamedAttribute;
import com.firefly.wcreate.jasper.runtime.JspRuntimeLibrary;
...
class Generator {
    ...
    private static final String VAR_EXPRESSIONFACTORY =
        System.getProperty("com.firefly.wcreate.jasper.compiler.Generator.VAR_EXPRESSIONFACTORY", "_el_expressionfactory");
    private static final String VAR_INSTANCEMANAGER =
        System.getProperty("com.firefly.wcreate.jasper.compiler.Generator.VAR_INSTANCEMANAGER", "_jsp_instancemanager");
    private static final boolean POOL_TAGS_WITH_EXTENDS =
        Boolean.getBoolean("com.firefly.wcreate.jasper.compiler.Generator.POOL_TAGS_WITH_EXTENDS");
    ...
    private static final boolean STRICT_GET_PROPERTY = Boolean.parseBoolean(
            System.getProperty(
                    "com.firefly.wcreate.jasper.compiler.Generator.STRICT_GET_PROPERTY",
                    "true"));
    ...
    private void generateGetters() {
        ...
        out.printil("public com.firefly.wcreate.rabbit.InstanceManager _jsp_getInstanceManager() {");
        out.pushIndent();
        if (!ctxt.isTagFile()) {
            out.printin("if (");
            ...
            out.println(" = com.firefly.wcreate.jasper.runtime.InstanceManagerFactory.getInstanceManager(getServletConfig());");
            out.popIndent();
            out.printil("}");
            out.popIndent();
            out.printil("}");
    ...
    private void generateInit() {
        ...
        if (isPoolingEnabled) {
            for (int i = 0; i < tagHandlerPoolNames.size(); i++) {
                ...
                out.print(" = com.firefly.wcreate.jasper.runtime.TagHandlerPool.getTagHandlerPool(");
                if (ctxt.isTagFile()) {
                    out.print("config");
                } else {
        ...
        if (ctxt.isTagFile()) {
            ...
            out.printin(VAR_INSTANCEMANAGER);
            out.println(" = com.firefly.wcreate.jasper.runtime.InstanceManagerFactory.getInstanceManager(config);");
        }
    ...
    private void genPreambleClassVariableDeclarations() {
        if (isPoolingEnabled && !tagHandlerPoolNames.isEmpty()) {
            for (int i = 0; i < tagHandlerPoolNames.size(); i++) {
                out.printil("private com.firefly.wcreate.jasper.runtime.TagHandlerPool "
        ...
        out.print(VAR_EXPRESSIONFACTORY);
        out.println(";");
        out.printin("private volatile com.firefly.wcreate.rabbit.InstanceManager ");
        out.print(VAR_INSTANCEMANAGER);
        out.println(";");
        out.println();
    }
    ...
    private void generatePreamble(Node.Nodes page) throws JasperException {
        ...
        out.printin("    implements com.firefly.wcreate.jasper.runtime.JspSourceDependent");
        ...
        if (pageInfo.isErrorPage()) {
            out.printil("java.lang.Throwable exception = com.firefly.wcreate.jasper.runtime.JspRuntimeLibrary.getThrowable(request);");
    ...
    class GenerateVisitor extends Node.Visitor {
        ...
        private String attributeValue(Node.JspAttribute attr, boolean encode,
            ...
            if (attr.isExpression()) {
                if (encode) {
                    return "com.firefly.wcreate.jasper.runtime.JspRuntimeLibrary.URLEncode(String.valueOf("
                ...
                if (encode) {
                    return "com.firefly.wcreate.jasper.runtime.JspRuntimeLibrary.URLEncode("
                            + v + ", request.getCharacterEncoding())";
                }
                return v;
        ...
        private void printParams(Node n, String pageParam, boolean literal)
            ...
            class ParamVisitor extends Node.Visitor {
                ...
                public void visit(Node.ParamAction n) throws JasperException {
                    ...
                    out.print(separator);
                    out.print(" + ");
                    out.print("com.firefly.wcreate.jasper.runtime.JspRuntimeLibrary."
        ...
        public void visit(Node.IncludeAction n) throws JasperException {
            ...
            out.printin("com.firefly.wcreate.jasper.runtime.JspRuntimeLibrary.include(request, response, "
                    + pageParam);
        ...
        public void visit(Node.GetProperty n) throws JasperException {
            ...
            if (beanInfo.checkVariable(name)) {
                ...
                out.printil("out.write(com.firefly.wcreate.jasper.runtime.JspRuntimeLibrary.toString("
                        + "((("
                        + beanName
                ...
                out.printil("out.write(com.firefly.wcreate.jasper.runtime.JspRuntimeLibrary.toString"
                        + "(com.firefly.wcreate.jasper.runtime.JspRuntimeLibrary.handleGetProperty"
                        + "(_jspx_page_context.findAttribute(\""
                        + name
                        + "\"), \""
                        + property
        ...
        public void visit(Node.SetProperty n) throws JasperException {
            ...
            if ("*".equals(property)) {
                out.printil("com.firefly.wcreate.jasper.runtime.JspRuntimeLibrary.introspect("
                        + "_jspx_page_context.findAttribute("
                        + "\""
                        + name + "\"), request);");
            } else if (value == null) {
                ...
                out.printil("com.firefly.wcreate.jasper.runtime.JspRuntimeLibrary.introspecthelper("
                        + "_jspx_page_context.findAttribute(\""
                        + name
                        + "\"), \""
                        + property
                ...
                out.printil("com.firefly.wcreate.jasper.runtime.JspRuntimeLibrary.handleSetProperty("
                        + "_jspx_page_context.findAttribute(\""
                        + name
                        + "\"), \"" + property + "\",");
                ...
                out.printil("com.firefly.wcreate.jasper.runtime.JspRuntimeLibrary.handleSetPropertyExpression("
                        + "_jspx_page_context.findAttribute(\""
                        + name
                        + "\"), \""
                        + property
                ...
                out.printin("com.firefly.wcreate.jasper.runtime.JspRuntimeLibrary.introspecthelper("
                        + "_jspx_page_context.findAttribute(\""
                        + name
                        + "\"), \"" + property + "\", ");
                out.print(attributeValue(value, false, null,
        ...
        public void visit(Node.InvokeAction n) throws JasperException {
            ...
            // page
            out.printil("((com.firefly.wcreate.jasper.runtime.JspContextWrapper) this.jspContext).syncBeforeInvoke();");
        ...
        private void generateCustomStart(Node.CustomTag n,
            ...
            if (!n.hasEmptyBody()) {
                ...
                if (n.implementsBodyTag()) {
                    ...
                    out.printin("out = com.firefly.wcreate.jasper.runtime.JspRuntimeLibrary.startBufferedBody(");
                    out.print("_jspx_page_context, ");
                    out.print(tagHandlerVar);
                    out.println(");");
                    out.popIndent();
        ...
        private void generateCustomEnd(Node.CustomTag n, String tagHandlerVar,
            ...
            out.printil("} finally {");
            out.pushIndent();
            out.printin("com.firefly.wcreate.jasper.runtime.JspRuntimeLibrary.releaseTag(");
            out.print(tagHandlerVar);
        ...
        private String evaluateAttribute(TagHandlerInfo handlerInfo,
            ...
            if (attr.isExpression()) {
                ...
                if (attr.getEL() != null && attr.getEL().getMapName() != null) {
                    sb.setLength(0);
                    sb.append("new com.firefly.wcreate.jasper.el.ELContextWrapper(");
                    sb.append(elContext);
                    sb.append(',');
                ...
                if (attr.isDeferredInput()
                    ...
                    sb.append("new com.firefly.wcreate.jasper.el.JspValueExpression(");
                    ...
                    sb.append("new com.firefly.wcreate.jasper.el.JspMethodExpression(");
                    sb.append(quote(mark));
        ...
        private String convertString(Class<?> c, String s, String attrName,
            ...
            if (propEditorClass != null) {
                ...
                return "("
                        + className
                        + ")com.firefly.wcreate.jasper.runtime.JspRuntimeLibrary.getValueFromBeanInfoPropertyEditor("
                ...
                return "("
                        + className
                        + ")com.firefly.wcreate.jasper.runtime.JspRuntimeLibrary.getValueFromPropertyEditorManager("
                        + className + ".class, \"" + attrName + "\", " + quoted
                        + ")";
            }
        }
        ...
        private void generateJspFragment(Node n, String tagHandlerVar)
            ...
            // the com.firefly.wcreate.jasper.runtime package as a support class.
    ...
    private void generateCommentHeader() {
        out.println("/*");
        out.println(" * Generated by the Jasper component of HKRT");
    ...
    private void generateTagHandlerPostamble(TagInfo tagInfo) {
        ...
        out.printil("((com.firefly.wcreate.jasper.runtime.JspContextWrapper) jspContext).syncEndTagFile();");
        if (isPoolingEnabled && !tagHandlerPoolNames.isEmpty()) {
    ...
    private void generateSetJspContext(TagInfo tagInfo) {
        ...
        if (aliasSeen) {
            out.printil("this.jspContext = new com.firefly.wcreate.jasper.runtime.JspContextWrapper(ctx, _jspx_nested, _jspx_at_begin, _jspx_at_end, aliasMap);");
        } else {
            out.printil("this.jspContext = new com.firefly.wcreate.jasper.runtime.JspContextWrapper(ctx, _jspx_nested, _jspx_at_begin, _jspx_at_end, null);");
        }
        out.popIndent();
        out.printil("}");
        out.println();
    ...
    private static class FragmentHelperClass {
        ...
        public void generatePreamble() {
            ...
            out.printil("    extends "
                    + "com.firefly.wcreate.jasper.runtime.JspFragmentHelper");
            out.printil("{");
            out.pushIndent();

...
import com.firefly.wcreate.jasper.runtime.JspFactoryImpl;
import com.firefly.wcreate.jasper.security.SecurityClassLoad;
...
public final class JspRuntimeContext {
    ...
    static {
        ...
        if( System.getSecurityManager() != null ) {
            String basePackage = "com.firefly.wcreate.jasper.";
            try {
    ...
    public JspRuntimeContext(ServletContext context, Options options) {
        ...
        if (context instanceof com.firefly.wcreate.jasper.servlet.JspCServletContext) {
            codeSource = null;
    ...
    private SecurityHolder initSecurity() {
        ...
        if( policy != null ) {
            try {          
                ...
                // Allow the JSP to access com.firefly.wcreate.jasper.runtime.HttpJspBase
                permissions.add( new RuntimePermission(
                    "accessClassInPackage.com.firefly.wcreate.jasper.runtime") );

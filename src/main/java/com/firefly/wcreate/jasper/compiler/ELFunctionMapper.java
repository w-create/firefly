...
public class ELFunctionMapper {
    ...
    class ELFunctionVisitor extends Node.Visitor {
        ...
        private void doMap(ELNode.Nodes el) 
            ...
            decName = getMapName();
            ss.append("private static com.firefly.wcreate.jasper.runtime.ProtectedFunctionMapper " + decName + ";\n");

            ds.append("  " + decName + "= ");
            ds.append("com.firefly.wcreate.jasper.runtime.ProtectedFunctionMapper");

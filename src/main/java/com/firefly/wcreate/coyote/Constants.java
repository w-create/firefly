...
public final class Constants {
    ...
    public static final String Package = "com.firefly.wcreate.coyote";
    ...
    public static final boolean USE_CUSTOM_STATUS_MSG_IN_HEADER =
            Boolean.getBoolean("com.firefly.wcreate.coyote.USE_CUSTOM_STATUS_MSG_IN_HEADER");
    ...
    public static final String COMET_SUPPORTED_ATTR =
        "com.firefly.wcreate.rabbit.comet.support";
     ...
     *
     * @see com.firefly.wcreate.rabbit.comet.CometEvent#setTimeout(int)
     */
    public static final String COMET_TIMEOUT_SUPPORTED_ATTR =
        "com.firefly.wcreate.rabbit.comet.timeout.support";
    ...
    public static final String COMET_TIMEOUT_ATTR =
        "com.firefly.wcreate.rabbit.comet.timeout";
    ...
    public static final String SENDFILE_SUPPORTED_ATTR =
        "com.firefly.wcreate.rabbit.sendfile.support";
    ...
    public static final String SENDFILE_FILENAME_ATTR =
        "com.firefly.wcreate.rabbit.sendfile.filename";
    ...
    public static final String SENDFILE_FILE_START_ATTR =
        "com.firefly.wcreate.rabbit.sendfile.start";
    ...
    public static final String SENDFILE_FILE_END_ATTR =
        "com.firefly.wcreate.rabbit.sendfile.end";
    ...
    public static final String REMOTE_ADDR_ATTRIBUTE =
            "com.firefly.wcreate.rabbit.remoteAddr";
}

...
import com.firefly.wcreate.coyote.http11.upgrade.NioProcessor;
...
import com.firefly.wcreate.rabbit.util.net.NioEndpoint.Handler;
...
public class Http11NioProtocol extends AbstractHttp11JsseProtocol<NioChannel> {
    ...
    protected static class Http11ConnectionHandler
        ...
        protected Processor<NioChannel> createUpgradeProcessor(
                ...
                throws IOException {
            return new com.firefly.wcreate.coyote.http11.upgrade.UpgradeNioProcessor(
                    socket, inbound,

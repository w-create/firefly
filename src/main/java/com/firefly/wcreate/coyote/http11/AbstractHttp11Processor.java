 ...
 */
package com.firefly.wcreate.coyote.http11;
...
import com.firefly.wcreate.coyote.AbstractProcessor;
import com.firefly.wcreate.coyote.ActionCode;
import com.firefly.wcreate.coyote.AsyncContextCallback;
import com.firefly.wcreate.coyote.ErrorState;
import com.firefly.wcreate.coyote.RequestInfo;
import com.firefly.wcreate.coyote.http11.filters.BufferedInputFilter;
import com.firefly.wcreate.coyote.http11.filters.ChunkedInputFilter;
import com.firefly.wcreate.coyote.http11.filters.ChunkedOutputFilter;
import com.firefly.wcreate.coyote.http11.filters.GzipOutputFilter;
import com.firefly.wcreate.coyote.http11.filters.IdentityInputFilter;
import com.firefly.wcreate.coyote.http11.filters.IdentityOutputFilter;
import com.firefly.wcreate.coyote.http11.filters.SavedRequestInputFilter;
import com.firefly.wcreate.coyote.http11.filters.VoidInputFilter;
import com.firefly.wcreate.coyote.http11.filters.VoidOutputFilter;
...
import com.firefly.wcreate.rabbit.util.buf.Ascii;
import com.firefly.wcreate.rabbit.util.buf.ByteChunk;
import com.firefly.wcreate.rabbit.util.buf.HexUtils;
import com.firefly.wcreate.rabbit.util.buf.MessageBytes;
import com.firefly.wcreate.rabbit.util.http.FastHttpDateFormat;
import com.firefly.wcreate.rabbit.util.http.MimeHeaders;
import com.firefly.wcreate.rabbit.util.log.UserDataHelper;
...
public abstract class AbstractHttp11Processor<S> extends AbstractProcessor<S> {
     ...
     */
    @Deprecated
    protected com.firefly.wcreate.coyote.http11.upgrade.UpgradeInbound upgradeInbound = null;
    ...
    public final void action(ActionCode actionCode, Object param) {
        ...
        case UPGRADE_TOMCAT: {
            upgradeInbound = (com.firefly.wcreate.coyote.http11.upgrade.UpgradeInbound) param;
    ...
    public SocketState process(SocketWrapper<S> socketWrapper)
        ...
        rp.setStage(com.firefly.wcreate.coyote.Constants.STAGE_PARSE);
        ...
        while (!getErrorState().isError() && keepAlive && !comet && !isAsync() &&
            ...
            if (!getErrorState().isError()) {
                ...
                rp.setStage(com.firefly.wcreate.coyote.Constants.STAGE_PREPARE);
                try {
                    prepareRequest();
                } catch (Throwable t) {
                    ExceptionUtils.handleThrowable(t);
            ...
            if (!getErrorState().isError()) {
                try {
                    rp.setStage(com.firefly.wcreate.coyote.Constants.STAGE_SERVICE);
            ...
            rp.setStage(com.firefly.wcreate.coyote.Constants.STAGE_ENDINPUT);
            ...
            rp.setStage(com.firefly.wcreate.coyote.Constants.STAGE_ENDOUTPUT);
            ...
            rp.setStage(com.firefly.wcreate.coyote.Constants.STAGE_KEEPALIVE);
        ...
        rp.setStage(com.firefly.wcreate.coyote.Constants.STAGE_ENDED);
    ...
    protected void prepareRequest() {
        ...
        if (endpoint.getUseSendfile()) {
            request.setAttribute(
                    com.firefly.wcreate.coyote.Constants.SENDFILE_SUPPORTED_ATTR,
                    Boolean.TRUE);
        }
        ...
        if (endpoint.getUseComet()) {
            request.setAttribute(
                    com.firefly.wcreate.coyote.Constants.COMET_SUPPORTED_ATTR,
                    Boolean.TRUE);
        }
        // Advertise comet timeout support
        if (endpoint.getUseCometTimeout()) {
            request.setAttribute(
                    com.firefly.wcreate.coyote.Constants.COMET_TIMEOUT_SUPPORTED_ATTR,
                    Boolean.TRUE);
        }
        if (getErrorState().isError()) {
    ...
    @Deprecated
    @Override
    public com.firefly.wcreate.coyote.http11.upgrade.UpgradeInbound getUpgradeInbound() {

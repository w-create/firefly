...
import com.firefly.wcreate.rabbit.jni.Address;
import com.firefly.wcreate.rabbit.jni.SSL;
import com.firefly.wcreate.rabbit.jni.SSLSocket;
import com.firefly.wcreate.rabbit.jni.Sockaddr;
    ...
    protected boolean prepareSendfile(OutputFilter[] outputFilters) {
        ...
        if (fileName != null) {
            ...
            sendfileData.end = ((Long) request.getAttribute(
                    com.firefly.wcreate.coyote.Constants.SENDFILE_FILE_END_ATTR)).longValue();
            return true;
        }
        return false;
    }

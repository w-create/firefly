...
import com.firefly.wcreate.coyote.http11.upgrade.AprProcessor;
...
import com.firefly.wcreate.rabbit.util.net.AprEndpoint.Handler;
import com.firefly.wcreate.rabbit.util.net.AprEndpoint.Poller;
...
public class Http11AprProtocol extends AbstractHttp11Protocol<Long> {
    ...
    protected static class Http11ConnectionHandler
        ...
        protected Processor<Long> createUpgradeProcessor(
                ...
                throws IOException {
            return new com.firefly.wcreate.coyote.http11.upgrade.UpgradeAprProcessor(
                    socket, inbound);
        }

...
import com.firefly.wcreate.rabbit.util.net.NioEndpoint;
import com.firefly.wcreate.rabbit.util.net.NioEndpoint.KeyAttachment;
import com.firefly.wcreate.rabbit.util.net.SSLSupport;
import com.firefly.wcreate.rabbit.util.net.SecureNioChannel;
import com.firefly.wcreate.rabbit.util.net.SendfileKeepAliveState;
...
public class Http11NioProcessor extends AbstractHttp11Processor<NioChannel> {
    ...
    public void actionInternal(ActionCode actionCode, Object param) {
        ...
        case COMET_CLOSE: {
            ...
            RequestInfo rp = request.getRequestProcessor();
            if (rp.getStage() != com.firefly.wcreate.coyote.Constants.STAGE_SERVICE) {
    ...
    protected boolean prepareSendfile(OutputFilter[] outputFilters) {
        ...
        if (fileName != null) {
            ...
            sendfileData.pos = ((Long) request.getAttribute(
                    com.firefly.wcreate.coyote.Constants.SENDFILE_FILE_START_ATTR)).longValue();
            sendfileData.length = ((Long) request.getAttribute(
                    com.firefly.wcreate.coyote.Constants.SENDFILE_FILE_END_ATTR)).longValue() - sendfileData.pos;
            return true;
        }
        return false;
    }

...
import com.firefly.wcreate.coyote.AbstractProtocol;
import com.firefly.wcreate.coyote.Processor;
import com.firefly.wcreate.coyote.http11.upgrade.BioProcessor;
...
import com.firefly.wcreate.rabbit.util.net.JIoEndpoint.Handler;
...
public class Http11Protocol extends AbstractHttp11JsseProtocol<Socket> {
    ...
    private static final com.firefly.wcreate.juli.logging.Log log
        = com.firefly.wcreate.juli.logging.LogFactory.getLog(Http11Protocol.class);
    ...
    protected static class Http11ConnectionHandler
        ...
        protected Processor<Socket> createUpgradeProcessor(
                ...
                throws IOException {
            return new com.firefly.wcreate.coyote.http11.upgrade.UpgradeBioProcessor(
                    socket, inbound);
        }

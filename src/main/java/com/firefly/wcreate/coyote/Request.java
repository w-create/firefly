...
import com.firefly.wcreate.rabbit.util.http.ContentType;
 ...
 * <ul>
 *   <li>"com.firefly.wcreate.rabbit.request" - allows access to the low-level
...
public final class Request {
     ...
     *   servlet container ( turnip connector, etc ), and values in 9 - 16 
     *   for connector use. 
     *   
    ...
    public boolean isProcessing() {
        return reqProcessorMX.getStage()==com.firefly.wcreate.coyote.Constants.STAGE_SERVICE;
    }
}

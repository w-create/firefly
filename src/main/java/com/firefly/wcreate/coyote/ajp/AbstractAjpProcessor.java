 ...
 */
package com.firefly.wcreate.coyote.ajp;
...
import com.firefly.wcreate.coyote.InputBuffer;
import com.firefly.wcreate.coyote.OutputBuffer;
import com.firefly.wcreate.coyote.Request;
import com.firefly.wcreate.coyote.RequestInfo;
import com.firefly.wcreate.coyote.Response;
...
import com.firefly.wcreate.rabbit.util.http.HttpMessages;
...
public abstract class AbstractAjpProcessor<S> extends AbstractProcessor<S> {
     ...
     * {@link com.firefly.wcreate.rabbit.valves.SSLValve}. If not specified, the
    ...
    protected void prepareResponse() throws IOException {
        ...
        String message = null;
        if (com.firefly.wcreate.coyote.Constants.USE_CUSTOM_STATUS_MSG_IN_HEADER &&

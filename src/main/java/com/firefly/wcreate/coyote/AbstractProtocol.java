...
import com.firefly.wcreate.coyote.http11.upgrade.servlet31.WebConnection;
...
import com.firefly.wcreate.rabbit.util.net.AbstractEndpoint.Handler;
...
public abstract class AbstractProtocol<S> implements ProtocolHandler,
    ...
    protected abstract static class AbstractConnectionHandler<S,P extends Processor<S>>
        ...
        public SocketState process(SocketWrapper<S> wrapper,
            ...
            try {
                ...
                do {
                    ...
                    if (state == SocketState.UPGRADING) {
                        ...
                        com.firefly.wcreate.coyote.http11.upgrade.UpgradeInbound inbound =
                ...
                if (state == SocketState.LONG) {
                    ...
                    } else if (processor instanceof com.firefly.wcreate.coyote.http11.upgrade.UpgradeProcessor) {
                        // NO-OP
                    } else {
            ...
            if (!(processor instanceof com.firefly.wcreate.coyote.http11.upgrade.UpgradeProcessor)
                    && !processor.isUpgrade()) {
                release(wrapper, processor, true, false);
            }
            return SocketState.CLOSED;
        ...
        protected abstract Processor<S> createUpgradeProcessor(
                ...
                com.firefly.wcreate.coyote.http11.upgrade.UpgradeInbound inbound) throws IOException;
        protected abstract Processor<S> createUpgradeProcessor(
                SocketWrapper<S> socket,
